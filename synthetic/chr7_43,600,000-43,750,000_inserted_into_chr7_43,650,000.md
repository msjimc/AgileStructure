...
For this analysis the reads at chr7 43,600,000 and chr7 43,650,000 where selected and analysed using the
...
For this analysis the reads at chr7 43,750,000 and 43,800,000 where selected and analysed using the
 ___Variant determination___ > ___Use soft clip data___ > ___Complex rearrangement___ menu option.
