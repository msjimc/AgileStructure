...
namespace AgileStructure
{
    ...
    public partial class Form1 : Form
    {
        ...
        //[DllImport(@"F:\\Ian C++\\BamReaderdll\\x64\\Debug\\BamReaderdll.dll", CallingConvention = CallingConvention.Cdecl)]
        ...
        //[DllImport(@"F:\\bamreader_plus\\BamReaderdll\x64\Release\\BamReaderdll.dll", CallingConvention = CallingConvention.Cdecl)]
        //public static extern Int32 getRegion(StringBuilder fileName, StringBuilder returnData, int len, UInt64 startPoint, int endPoint);

        //[DllImport(@"F:\\Ian C++\\BamReaderdll\\x64\\Release\\BamReaderdll.dll", CallingConvention = CallingConvention.Cdecl)]
        //public static extern Int32 getRegionReturnSize(StringBuilder fileName, StringBuilder count, UInt64 startPoint, int endPoint);
        ...
        //[DllImport(@"F:\\bamreader_plus\\BamReaderdll\\x64\\Debug\\BamReaderdll.dll", CallingConvention = CallingConvention.Cdecl)]
        //public static extern Int32 getRegion(StringBuilder fileName, StringBuilder returnData, int len, UInt64 startPoint, int endPoint);
        ...
        private void insertionToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                if (selectedIndex.Count > 0 && cboSecondaries.SelectedIndex > 0)
                {
                    ...
                    if (bestPlaces[1] == null)
                    { MessageBox.Show("Could not find all the breakpoints", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error); return; }
        ...
        private void variantTypeToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            catch { MessageBox.Show("Something went wrong does the alignments contian softclipped cigar strings!", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error); }
        }
